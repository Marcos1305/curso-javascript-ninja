  ...
  */
  var person1 = { name: 'Marcos', lastName: 'Vinicius'};
  var person2 = { name: 'Bianca', lastName: 'Fraga'};
  ...
  */
  function sum(){
    ...
    var soma = Array.prototype.reduce.call(arguments, function(acumulated, actual){
  ...
  */
  ...
  console.log(sum(1,2,3,4,5,1,2,3,45,5,123,12));
  console.log(sum(10,20,30,40,50,60));
  console.log(sum(1000, 2000, 3000, 4000));
  ...
  */
  ...
  var clearFix = string.replace(/\D+/g, ',').split(',');
    return clearFix;
  }
