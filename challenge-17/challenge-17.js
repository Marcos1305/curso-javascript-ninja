...
var myVersion = text.replace(/Manuel Marques de Sousa/g,  'Marcos Vinicius Domingos Ferreira');
...
var myVersion = myVersion.replace(/brasileiro/g, 'capixaba' )
console.log(myVersion)
/*
...
console.log(text.replace(/´O Centauro de Luvas´/g, function(total){
