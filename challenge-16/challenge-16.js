(function(){
			...
			*/
			...
			var fullName = 'marcos-vinicius-domingos-ferreira';
			...
			*/
			console.log( '\nMeus amigos:' );
			var friends = ['João' , 'Maria' , 'Roberto', 'Pedro', 'José']
			
			var friendsResult = friends.reduce(function(acumulado, atual, index){
