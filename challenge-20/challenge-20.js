(function (window, document) {
            ...
            */
            $button.addEventListener('click', function(event){
                ...
                if(!isValidEmail.test($inputEmail.value) && $inputEmail.value !== ''){
                    alert('Entre com email válido')
                    event.preventDefault();
            ...
            */
            var isValidEmail = /^[\w+.]+@\w+\.\w{2,}(?:\.\w{2})?$/;
            var emailtestearray = ["meu.email+categoria@gmail.com",
                ,"juca_malandro@bol.com.br"
                , "pedrobala@hotmail.uy"
                , "sandro@culinaria.dahora",
                ,"walter-da-silva@maraca.br"
                , "rita-marica@titica.a.b"
                , "agua_@evida.br.com"]
                emailtestearray.forEach( function(array){
                    console.log(array.match(isValidEmail));
