(function () {
					...
					*/
					...
					var cpfFormated =	cpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/g, '$1.$2.$3-$4')
					return cpfFormated;
					}
					...
					*/
					...
					console.log(text.match(regextag));
					/*
					...
					*/
					...
					var regextagnull = /<\w+><[/]\w+>/g
					var textnull = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
					console.log(textnull.match(regextagnull));
